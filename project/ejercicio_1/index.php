...
<div class="container">
    ...
    <div class="content">
        ...
        <?php
            if (isset($_POST['number_one']) and isset($_POST['number_two'])) {
                $number_one = $_POST['number_one'];
                $number_two = $_POST['number_two'];

                $not_divisor = $number_two % $number_one;

                $message = $number_one . " es divisor de " . $number_two;

                if($not_divisor) {
                    $message = $number_one . " no es divisor de " . $number_two;
                }
        ?>
                <br>
